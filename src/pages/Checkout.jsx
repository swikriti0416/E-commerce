...
const Checkout = () => {
  ...
  if (cart.length === 0) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-orange-50 to-amber-50 text-center dark:from-blackish-soft dark:via-blackish dark:to-blackish/95 px-6">
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-white to-amber-50 py-16 dark:from-blackish-soft dark:via-blackish dark:to-blackish/95 flex flex-col items-center justify-center px-6">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="grid lg:grid-cols-3 gap-12">
          ...
          <div className="lg:col-span-2">
            <div className="bg-white/90 backdrop-blur rounded-3xl p-10 border border-orange-100 shadow-[0_20px_50px_rgba(0,0,0,0.08)] dark:bg-gray-800/90 dark:border-orange-100">
          ...
          <div className="bg-gradient-to-br from-orange-150 to-white rounded-3xl p-8 h-fit border border-orange-100 shadow-[0_20px_40px_rgba(0,0,0,0.08)]">
            <h2 className="text-2xl font-extrabold mb-6 text-gray-600 dark:text-white">Order Summary</h2>
            ...
            <div className="border-t border-orange-200 my-6 pt-6 space-y-4">
              ...
              <div className="text-gray-700 dark:text-gray-200 flex justify-between items-center">
                <span>Shipping</span>
              ...
              <div className="flex justify-between items-center pt-6 mt-4 border-t border-orange-200">
                <span className="text-xl font-extrabold text-gray-600 dark:text-gray-200">Total</span>
            ...
            <Link
              to="/cart"
              className="flex items-center justify-center gap-2 text-gray-600 hover:text-gray-900 mt-6 font-medium dark:text-gray-400 dark:hover:text-white transition transform hover:scale-105"
            >
              <FaArrowLeft />
              Back to Cart
            </Link>
